...
// Exercitiul 1 - sa se afiseze in consola
// id-ul tuturor produselor care contin cuvantul "slim" fie in titlu, fie in descriere

for (let i = 0; i < products.length; i++) {
  if (
    products[i].title.toLowerCase().includes('slim') ||
    products[i].description.toLowerCase().includes('slim')
  )
    console.log(products[i].id);
}

// Exercitiul 2 - sa se afiseze in consola toate produsele din zona de haine
// ( va coordonati dupa cele 2 categorii - "women's clothing" si "men's clothing"
...
console.log(maxRatingElectronics.title);

// Exercitiul 6 - sa se afiseze in consola produsul cu rating-ul cel mai mare:
//  "The most popular product is X and it rated of Y out of 5 by Z reviewers"

let maxRatingProducts = products[0];

for (let i = 1; i < products.length; i++) {
  if (maxRatingProducts.rating.rate < products[i].rating.rate) {
    maxRatingProducts = products[i];
  }
}

console.log(
  `The most popular product is ${maxRatingProducts.title} and it rated of ${maxRatingProducts.rating.rate} out of 5 by ${maxRatingProducts.rating.count} reviewers.`
);
